...
const Welcome = (e) => {
    ...
    return (
        <div className="flex w-full justify-center items-center">
            <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4 w-9/12">
                <div className="flex flex-1 justify-start items-start flex-col mf:mr-10 w-full sm:w-11/12">
                    ...
                    <p className="text-left mt-5 text-white font-light md:w-9/12 w-11/12 text-base">
                            Explore the crypto world. Buy and sell cryptocurrencies easily on cryptPay!
                    </p>
                    {/* connect button */}
                    ...
                    <div className="grid sm:grid-cols-3 grid-cols-2 w-full mt-10">
                        ...
                        <div className= {commonStyles}>unparallel Security</div>
                        ...
                        {/* card element */}
                        <div className="flex flex-row items-center justify-around w-full mt-10 custom_tall:flex-col">
